"""
Django settings for frosty_snowflake_42709 project.
...
ROOT_URLCONF = 'frosty_snowflake_42709.urls'
...
WSGI_APPLICATION = 'frosty_snowflake_42709.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_snowflake_42709 API",
    "DESCRIPTION": "API documentation for frosty_snowflake_42709 App",
    "VERSION": "v1",
}
